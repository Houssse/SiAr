...
RSpec.describe Article, type: :model do
  context "validations" do
    ...
    it "is valid with a title of minimum 5 charcters" do
      article = Article.new(title: "Title", content: "Valid body")
      expect(article).to be_valid  
    end
    
    it "is invalid with a title less than 5 characters" do
      article = Article.new(title: "Test", content: "Valid Body")
    ...
    it "is valid with a title of maximum 100 characters" do
      article = Article.new(title: "A" * 100, content: "Valid Body")
      expect(article).to be_valid  
    end
    
    it "is invalid with a title longer than 100 characters" do
      article = Article.new(title: "A" * 101, content: "Valid Body")
      expect(article).to_not be_valid
    ...
    it "is valid with a body of minimum 5 characters" do
      article = Article.new(title: "Valid Title", content: "Valid Body")
      expect(article).to be_valid  
    end

    it "is invalid with a body less than 5 characters" do
      article = Article.new(title: "Valid Title", content: "Test")
      expect(article).to_not be_valid
